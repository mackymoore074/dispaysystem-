...
namespace SystemModels.Migrations
{
    ...
    [Migration("20241126194202_UpdateModels")]
            ...
            modelBuilder.Entity("SystemModels.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgencyId = 1,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4874),
                            DepartmentId = 1,
                            Email = "johndoe@agency.com",
                            FirstName = "John",
                            LastLogin = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4876),
                            LastName = "Doe",
                            LocationId = 1,
                            PasswordHash = "ade123",
                            Role = 2,
                        ...
                        new
                        {
                            Id = 2,
                            AgencyId = 2,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4879),
                            DepartmentId = 2,
                            Email = "janesmith@agency.com",
                            FirstName = "Jane",
                            LastLogin = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4880),
                            LastName = "Smith",
                            LocationId = 2,
                            PasswordHash = "ade123",
                            Role = 1,
            ...
            modelBuilder.Entity("SystemModels.Models.Agency", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4629),
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4668),
            ...
            modelBuilder.Entity("SystemModels.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgencyId = 1,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4789),
                        ...
                        new
                        {
                            Id = 2,
                            AgencyId = 2,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4793),
            ...
            modelBuilder.Entity("SystemModels.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4806),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "456 HR Ave",
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4809),
                            Name = "Main Office (HR)"
                        });
                });
            ...
            modelBuilder.Entity("SystemModels.Models.NewsItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Agency = "Agency1",
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4894),
                            ImportanceLevel = 1,
                            LastUpdated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4898),
                            MoreInformationUrl = "http://example.com",
                            NewsItemBody = "System maintenance scheduled.",
                            TimeOutDate = new DateTime(2024, 12, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4895),
                        ...
                        new
                        {
                            Id = 2,
                            Agency = "Agency2",
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4900),
                            ImportanceLevel = 2,
                            LastUpdated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4904),
                            MoreInformationUrl = "http://example.com",
                            NewsItemBody = "New company policy in effect.",
                            TimeOutDate = new DateTime(2024, 12, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4902),
                            Title = "New Policy"
                        });
                });
            ...
            modelBuilder.Entity("SystemModels.Models.Screen", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4822),
                            DepartmentId = 1,
                            IsOnline = true,
                            LastCheckedIn = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4825),
                            LastUpdated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4824),
                            LocationId = 1,
                            Name = "DM001",
                            ScreenType = "LED",
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4854),
                            DepartmentId = 2,
                            IsOnline = true,
                            LastCheckedIn = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4857),
                            LastUpdated = new DateTime(2024, 11, 26, 11, 42, 1, 664, DateTimeKind.Local).AddTicks(4856),
                            LocationId = 2,
                            Name = "LH002",
                            ScreenType = "LCD",
                            StatusMessage = "Active"
